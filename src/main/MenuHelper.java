...
public class MenuHelper {
    ...
    public static JMenuItem addMenuItem(JMenu parent, String text, ActionListener actionListener) {
        //parent — menu to which we were adding something, text — adding text, actionListener — menu item action listener
    ...
    public static void initColorMenu(View view, JMenuBar menuBar) {
        ...
        addMenuItem(colorMenu, new StyledEditorKit.ForegroundAction("Oraqnge", Color.orange));
